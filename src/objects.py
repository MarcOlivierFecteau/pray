...
class Metal(Material):
    ...
    def scatter(self, ray: Ray, record: HitRecord):
        ...
        reflected += self.__fuzz * Vector3.random_unit()
...
class Dielectric(Material):
    __refraction_index: float  # In vacuum or air, or the ratio of the material's refractive index over the refractive index of the enclosing media
    ...
    def scatter(self, ray: Ray, record: HitRecord):
        ...
        refraction_index = (
            1.0 / self.__refraction_index
            if record._front_face
            else self.__refraction_index
        )
